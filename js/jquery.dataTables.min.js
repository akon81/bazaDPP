...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Wczytywanie...",sLengthMenu:"Pokaż _MENU_ rekordów",sZeroRecords:"Nie ma pasujących rekordów",sEmptyTable:"Brak danych w tabeli",
sLoadingRecords:"Loading...",sInfo:"Wyświetlone _START_ do _END_ z _TOTAL_ rekordów",sInfoEmpty:"Wyświetlone 0 z 0 rekordów",sInfoFiltered:"",sInfoPostFix:"",sInfoThousands:",",sSearch:"Szukaj:",sUrl:"",oPaginate:{sFirst:"Pierwsza",sPrevious:"Poprzednia",sNext:"Następna",sLast:"Ostatnia"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
