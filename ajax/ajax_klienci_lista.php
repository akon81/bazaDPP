<?php
  require_once("../funkcje_glowne_strony.php");
	 ...
	 */
	$aColumns = array('name', 'descript', 'id');
		...
		while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
			...
			//		
			if ($i==2) $row[]="<a class='btn pencil' title='szczegóły / edytuj'><span style='display:none;'>".$aRow[ $aColumns[$i] ]."</span></a> <a class='btn trash' title='usuń z bazy danych'></a>"; 
